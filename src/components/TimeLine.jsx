  ...
  return (
    <div className="flex flex-col items-center justify-center bg-white">
      ...
      <div className="relative w-4/5 mt-10">
        ...
        {/* Animated fill */}
        <div
          className="absolute left-0 h-1 transition-all ease-in-out transform -translate-y-1/2 rounded-full top-1/2 bg-linear-to-r from-orange-400 to-purple-500 duration-2000"
        ...
        <div className="flex justify-between mt-10 ">
          {steps.map((label, i) => (
            <div key={i} className="flex flex-col items-center w-1/4 ">
              <div
                className={`w-6 h-6 z-50 rounded-full border-4 ${
