    ...
    <section className="relative w-full lg:overflow-hidden">
      ...
      <motion.div
        ...
        className="
          ...
          md:mt-40 sm:mt-40 md:my-16 lg:my-20 
      ...
      >
        ...
        <motion.div
          ...
          className="flex flex-col w-full sm:w-4/5 md:w-1/2 lg:w-[35vw] gap-6 text-center lg:text-left"
        >
          {/* Header */}
          <motion.div
            variants={itemVariants}
          ...
          <motion.p
            variants={itemVariants}
            className="text-base sm:text-lg font-medium text-gray-700 xl:w-3/4 leading-relaxed"
          >
          ...
          <motion.button
            variants={itemVariants}
            className="mt-4 px-8 py-3 w-fit md:w-1/2 bg-[#0F0B43] text-white font-semibold rounded-2xl hover:bg-[#191368] transition-colors mx-auto lg:mx-0"
          >
            Learn more
          </motion.button>
        </motion.div>
